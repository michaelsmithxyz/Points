...
public class WarpDelete extends ArgumentSet {
    ...
    public WarpDelete(Command base, String pat, JavaPlugin plugin, Permission ... perms) {
    ...
    public boolean execute(CommandSender sender, String command, String[] args) {
        ...
        if(warp == null)
            ...
            player.sendMessage(_("warpDeleted", args[1]));
        }
        return true;
    }
    ...
    public Pair<String, String> getHelp() {
        return new Pair<String, String>("/warp delete [name]", "Deletes the warp by the given name");
    }
