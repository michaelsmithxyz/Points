...
public class WarpPublic extends ArgumentSet {
    
    public WarpPublic(Command base, String pat, JavaPlugin plugin, Permission ... perms) {
    ...
    public Pair<String, String> getHelp() {
        return new Pair<String, String>("/warp public [name]", "Set a warp as public");
    }
